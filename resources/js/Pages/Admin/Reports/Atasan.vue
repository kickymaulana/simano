...
const props = defineProps<{ periods: Period[]; targets: Target[]; selectedPeriod: Period | null; selectedTarget: { id: number; name: string; nik?: string; avatar_url?: string | null; departments?: string | null } | null; targetPosition: { id: number; name: string } | null; rows: Row[]; evaluatorCount: number; filters: { period: number | null; target: number | null } }>();
