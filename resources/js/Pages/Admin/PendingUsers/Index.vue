...
defineProps<{ users: Array<{ id: number; nik: string; name: string; email?: string; requested_role: string; created_at: string }> }>();
            ...
            <div v-else class="overflow-x-auto">
                <table class="w-full min-w-[700px] text-left text-sm">
                    <thead class="border-b border-slate-200 text-slate-500">
                        <tr><th class="p-3">Nama</th><th class="p-3">NIK</th><th class="p-3">Role diminta</th><th class="p-3">Aksi</th></tr>
                    </thead>
                    <tbody>
